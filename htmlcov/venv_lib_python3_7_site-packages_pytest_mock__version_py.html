...
<head>
    ...
    <title>Coverage for venv/lib/python3.7/site-packages/pytest_mock/_version.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>venv/lib/python3.7/site-packages/pytest_mock/_version.py</b> :
...
<div id="source">
    ...
    <p id="t4" class="run"><span class="n"><a href="#t4">4</a></span><span class="t"><span class="nam">version</span> <span class="op">=</span> <span class="str">'3.1.0'</span>&nbsp;</span><span class="r"></span></p>
</div>
<div id="footer">
    <div class="content">
        <p>
